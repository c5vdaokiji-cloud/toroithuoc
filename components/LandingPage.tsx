  ...
  return (
    <div className="min-h-screen text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300 overflow-x-hidden relative bg-slate-50 dark:bg-slate-950 selection:bg-brand-500 selection:text-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        {/* Blob 1 */}
        <div 
           className="absolute -top-[10%] -right-[10%] w-[50rem] h-[50rem] will-change-transform"
           style={{ transform: `translate3d(0, ${scrollY * 0.5}px, 0)` }}
        >
           <div className="w-full h-full rounded-full bg-brand-400/20 dark:bg-brand-900/20 blur-[100px] opacity-60 mix-blend-multiply dark:mix-blend-screen animate-blob will-change-transform"></div>
        </div>

        {/* Blob 2 */}
        <div 
           className="absolute top-[20%] -left-[10%] w-[45rem] h-[45rem] will-change-transform"
           style={{ transform: `translate3d(0, ${scrollY * 0.4}px, 0)` }}
        >
           <div className="w-full h-full rounded-full bg-accent-400/20 dark:bg-accent-900/20 blur-[100px] opacity-60 mix-blend-multiply dark:mix-blend-screen animate-blob animation-delay-2000 will-change-transform"></div>
        </div>
      </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden min-h-screen flex flex-col justify-center">
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <div style={{ transform: `translate3d(0, ${scrollY * 0.2}px, 0)`, opacity: 1 - Math.min(1, scrollY / 700) }} className="will-change-transform">
              <ScrollReveal>
          ...
          <div 
            className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-12 hidden xl:block will-change-transform"
          ...
          <div 
            className="absolute top-1/3 right-0 -translate-y-1/2 translate-x-12 hidden xl:block will-change-transform"
